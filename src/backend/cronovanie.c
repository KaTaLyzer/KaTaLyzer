...
inline void *cronovanie ( void *arg)
{
        ...
        char prikaz[100000];
	unsigned int len; // dlzka prikazu
        switch ( cas ) {
        case 5:
                sprintf ( mhd,"5m" );
                sprintf ( nl,"1m" );
...
///////////////////
        ...
        if ( mysql_query ( conn,prikaz ) ) {
                fprintf ( stderr,"Failed to show tables '%s' from MYSQL database %s: %s\n",prikaz,db_name,mysql_error ( conn ) );
        }
...
///////////////////////////
        ...
        for ( table=prvy;table!=NULL;table=table->dalsi ) {
                if ( strstr ( table->nazov,"SIP" ) !=NULL ) ;
                        ...
                        if ( !table->is_ipv6 )
                                sprintf ( kreatura,"CREATE TABLE IF NOT EXISTS %s_%s_time (`time` int(10) unsigned NOT NULL default '0',`IP_id` int(10) unsigned NOT NULL default '0',`MAC_id` int(10) unsigned NOT NULL default '0',`IP_SD_id` int(10) unsigned NOT NULL default '0',`MAC_SD_id` int(10) unsigned NOT NULL default '0',PRIMARY KEY (`time`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;CREATE TABLE IF NOT EXISTS %s_%s_IP(`id` int(10) unsigned NOT NULL auto_increment,`IP` int unsigned default '0',`bytes_S` bigint(20) unsigned NOT NULL default '0',`packets_S` bigint(20) unsigned NOT NULL default '0',`bytes_D` bigint(20) unsigned NOT NULL default '0',`packets_D` bigint(20) unsigned NOT NULL default '0',PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;\
                                CREATE TABLE IF NOT EXISTS %s_%s_MAC(`id` int(10) unsigned NOT NULL auto_increment,`MAC` bigint unsigned default '0',`bytes_S` bigint(20) unsigned NOT NULL default '0',`packets_S` bigint(20) unsigned NOT NULL default '0',`bytes_D` bigint(20) unsigned NOT NULL default '0',`packets_D` bigint(20) unsigned NOT NULL default '0',PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;CREATE TABLE IF NOT EXISTS %s_%s_IP_SD(`id` int(10) unsigned NOT NULL auto_increment,`IP_1` int unsigned default '0',`IP_2` int unsigned default '0',`bytes_12` bigint(20) unsigned NOT NULL default '0',`packets_12` bigint(20) unsigned NOT NULL default '0',`bytes_21` bigint(20) unsigned NOT NULL default '0',`packets_21` bigint(20) unsigned NOT NULL default '0',PRIMARY KEY (`id`))  ENGINE=MyISAM DEFAULT CHARSET=latin1;\
                                CREATE TABLE IF NOT EXISTS %s_%s_MAC_SD(`id` int(10) unsigned NOT NULL auto_increment,`MAC_1` bigint unsigned default '0',`MAC_2` bigint unsigned default '0',`bytes_12` bigint(20) unsigned NOT NULL default '0',`packets_12` bigint(20) unsigned NOT NULL default '0',`bytes_21` bigint(20) unsigned NOT NULL default '0',`packets_21` bigint(20) unsigned NOT NULL default '0',PRIMARY KEY (`id`))  ENGINE=MyISAM DEFAULT CHARSET=latin1;",table->nazov,mhd,table->nazov,mhd,table->nazov,mhd, table->nazov,mhd,table->nazov,mhd );
                        else
                                sprintf ( kreatura,"CREATE TABLE IF NOT EXISTS %s_%s_time (`time` int(10) unsigned NOT NULL default '0',`IP_id` int(10) unsigned NOT NULL default '0',`MAC_id` int(10) unsigned NOT NULL default '0',`IP_SD_id` int(10) unsigned NOT NULL default '0',`MAC_SD_id` int(10) unsigned NOT NULL default '0',PRIMARY KEY (`time`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;CREATE TABLE IF NOT EXISTS %s_%s_IP(`id` int(10) unsigned NOT NULL auto_increment,`IP` char(32),`bytes_S` bigint(20) unsigned NOT NULL default '0',`packets_S` bigint(20) unsigned NOT NULL default '0',`bytes_D` bigint(20) unsigned NOT NULL default '0',`packets_D` bigint(20) unsigned NOT NULL default '0',PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;\
                                CREATE TABLE IF NOT EXISTS %s_%s_MAC(`id` int(10) unsigned NOT NULL auto_increment,`MAC` bigint unsigned default '0',`bytes_S` bigint(20) unsigned NOT NULL default '0',`packets_S` bigint(20) unsigned NOT NULL default '0',`bytes_D` bigint(20) unsigned NOT NULL default '0', `packets_D` bigint(20) unsigned NOT NULL default '0',PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;CREATE TABLE IF NOT EXISTS %s_%s_IP_SD(`id` int(10) unsigned NOT NULL auto_increment,`IP_1` char(32),`IP_2` char(32),`bytes_12` bigint(20) unsigned NOT NULL default '0',`packets_12` bigint(20) unsigned NOT NULL default '0',`bytes_21` bigint(20) unsigned NOT NULL default '0',`packets_21` bigint(20) unsigned NOT NULL default '0',PRIMARY KEY (`id`))  ENGINE=MyISAM DEFAULT CHARSET=latin1;\
                                CREATE TABLE IF NOT EXISTS %s_%s_MAC_SD(`id` int(10) unsigned NOT NULL auto_increment,`MAC_1` bigint unsigned default '0',`MAC_2` bigint unsigned default '0',`bytes_12` bigint(20) unsigned NOT NULL default '0',`packets_12` bigint(20) unsigned NOT NULL default '0',`bytes_21` bigint(20) unsigned NOT NULL default '0',`packets_21` bigint(20) unsigned NOT NULL default '0',PRIMARY KEY (`id`))  ENGINE=MyISAM DEFAULT CHARSET=latin1;",table->nazov,mhd,table->nazov,mhd,table->nazov,mhd,table->nazov,mhd,table->nazov,mhd );
        ...
        if ( mysql_query ( conn, prikaz ) ) {
                fprintf ( stderr,"Failed to create tables '%s' for MYSQL database %s: %s\n",prikaz,db_name,mysql_error ( conn ) );
                exit ( -1 );
        }
...
//KONTROLA, CI JE VOBEC CO SPRACOVAVAT
                ...
                if ( mysql_query ( conn,prikaz ) ) {
                        fprintf ( stderr,"Failed to select '%s' from MYSQL database %s: %s\n",prikaz,db_name,mysql_error ( conn ) );
                }
...
//ZISTENIE ROZSAHOV SPRACOVAVANYCH IDciek
                        /*OD*/
                        sprintf ( prikaz,"SELECT IP_id,MAC_id,IP_SD_id,MAC_SD_id FROM %s_%s_time WHERE time>='%d';",table->nazov,nl,mhd_time[0] );
                        if ( mysql_query ( conn,prikaz ) ) {
                                fprintf ( stderr,"Failed to select '%s' from MYSQL database %s: %s\n",prikaz,db_name,mysql_error ( conn ) );
                        }
                        if ( ( ( result = mysql_store_result ( conn ) ) !=NULL ) && ( ( row=mysql_fetch_row ( result ) ) !=NULL ) ) {
